...
template <class Type>
Type HurdleDemand3RE_SND(objective_function<Type>* obj) {
  // DATA
  DATA_VECTOR(price);
  DATA_VECTOR(logQ);
  DATA_IVECTOR(delta);
  ...
  for (int i = 0; i < n; i++) {
    ...
    Type mu_ij = (log_q0 + b_i) - alpha_i * Q0_i * price(i);
