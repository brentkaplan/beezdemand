...
A list with: - \`data\`: Modified data frame with new collapsed factor
columns - \`new_factor_names\`: Character vector of new factor column
names to use - \`info\`: List with original and new levels for each
collapsed factor
