...
- You want to model both the probability of consuming and the intensity
  of consumption simultaneously
...
#> 4  60  31.73720  0.1663613  8.202899 0.09878809  14.204504   20 36.58858
...
#> 1          20.000000           51.84539
#> 2          20.000000           16.13182
...
and choosing the wrong one changes any score computed against observed
data:
...
The hurdle model is implemented in Template Model Builder (TMB), which
provides a Laplace approximation to the marginal likelihood, automatic
differentiation for the optimizer, and delta-method standard errors.
