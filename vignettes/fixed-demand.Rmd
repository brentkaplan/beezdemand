...
Fixed-effect models are appropriate when
...
All modeling functions expect long-format data with columns
...
The `fit_demand_fixed()` interface provides a consistent API for
