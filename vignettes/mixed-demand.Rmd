...
This vignette is organized for different experience levels:

- **Quick Start (Beginners)**: Sections "Data Preparation" through "Inspecting Fits" cover essential workflow (~15-20 minutes). Start here if you're new to mixed-effects demand modeling.

- **Intermediate Usage**: Sections "Diagnostics" through "Performing Pairwise Comparisons" cover factor models, post-hoc inference, and practical model selection (~30-40 minutes). Use these sections when you need to model group differences or covariates.

- **Advanced Topics**: The final "Advanced Topics" section covers complex random effects structures, continuous covariates, and custom model specifications (~60+ minutes). These techniques are for experienced users with specific modeling needs.
...
**Note**: This section covers advanced modeling techniques for experienced users. If you're new to mixed-effects demand modeling, the sections above provide everything needed for most analyses. These advanced topics require deeper understanding of mixed-effects models and may be computationally intensive.
