...
- `type = "ssr"` (default): sum-of-squared residuals on aggregated price-level
  means — a quick visual check of the fixed-effects landscape
- `type = "marginal"`: linearized marginal negative log-likelihood that
  integrates over random-effects variance — more statistically appropriate for
  mixed models and preferred for assessing identifiability near the MLE
