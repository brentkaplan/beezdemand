...
As of TICKET-022 the default behavior of `get_subject_pars()`
...
message pointing at `get_subject_pars(fit, expanded = TRUE)` (or, post
TICKET-022, simply `get_subject_pars(fit)`) for per-(subject,
factor-level) values that the caller can aggregate. Native
