...
Behavioral economic demand is gaining in popularity. In my experience,
many researchers who do research in this field use (relatively)
expensive, proprietary software to conduct their analyses. I was
motivated to create an alternative tool to conduct these
analyses. This package is not necessarily meant to be a replacement
for those other softwares; rather, it is meant to serve as an
