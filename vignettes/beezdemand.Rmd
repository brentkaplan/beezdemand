...
Now we can convert into a long format using some of the helpful functions in the `tidyr` package (make sure the package is loaded before trying the commands below).
