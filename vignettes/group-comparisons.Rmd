...
> **Note:** For formal statistical inference on group differences, we recommend the mixed-effects
> models in `vignette("mixed-demand")`, which provide random effects and estimated marginal means.
> `ExtraF()` remains useful for quick, traditional group comparisons.
